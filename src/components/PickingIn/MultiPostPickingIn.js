...
import EditPickingIn from "./EditPickingIn.js";
...
function MultiPostPickingIn() {
  ...
  const [listBookPickingIn, setListBookPickingIn] = useState([]);
...
export default MultiPostPickingIn;
